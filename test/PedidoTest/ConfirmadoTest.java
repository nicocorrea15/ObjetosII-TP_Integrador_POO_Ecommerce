...
class ConfirmadoTest {
	...
	void errorAgregar() {
		...
		RuntimeException exAgregar = assertThrows(RuntimeException.class, () -> {confirmado.agregarProducto(null);});
	...
	void errorEliminar() {
		...
		RuntimeException exEliminar = assertThrows(RuntimeException.class, () -> {confirmado.eliminarProducto(null);});
